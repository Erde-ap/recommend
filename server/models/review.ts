...
const Review_model = mongoose.model('Review', Review);
const ReviewCom_model = mongoose.model('ReviewCom', ReviewCom);
const ReviewCon_model = mongoose.model('ReiviewCon', ReviewCon);

const Review_Obj = [Review_model, ReviewCom_model, ReviewCon_model];
